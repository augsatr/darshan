    ...
    <main className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-5">
        <div className="space-y-1 text-center">
          <h1 className="text-2xl font-bold text-emerald-900">Sign in</h1>
          <p className="text-sm text-stone-500">Save temples and leave reviews</p>
        </div>
        ...
        <p className="text-sm text-stone-500 text-center">
          No account? <Link href="/auth/signup" className="text-emerald-600 hover:underline">Sign up</Link>
        </p>
      </form>
    </main>
  );
